...
@pytest.mark.asyncio
async def test_ingest_endpoint(mock_db):
    from unittest.mock import MagicMock, patch
    with patch('backend.services.container.AsyncIOMotorClient') as mock_motor_client:
        mock_client = MagicMock()
        mock_client.__getitem__.side_effect = lambda key: mock_db
